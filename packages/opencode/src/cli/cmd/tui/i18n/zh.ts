...
export const dict = {
  ...
  "tui.skill.browser-use.description": "默认通过 Browser Use CLI 操作浏览器",
  "tui.skill.playwright.description": "仅在明确请求时使用 Playwright CLI 自动化",
  ...
  "tui.skill.browser-use.slash": "浏览器自动化",
  "tui.skill.playwright.slash": "Playwright",
  ...
  "tui.command.voice.send.title": "切换语音发送",
  ...
  "tui.voice.send.enabled": "语音发送已启用 — 语音控制模式下说「发送」即可提交输入",
  "tui.voice.send.disabled": "语音发送已关闭",
  "tui.voice.control.enabled": "智能编辑已开启 — 理解编辑意图，需要一定思考时间",
  "tui.voice.control.disabled": "已切到快速输入 — 无意图理解，响应更快，方言/噪声环境更稳",
  "tui.command.voice.control.title": "切换智能编辑 / 快速输入",
  "tui.command.voice.control.title_on": "智能编辑：已开启 — 点击切到快速输入",
  "tui.command.voice.control.title_off": "快速输入：已开启 — 点击切到智能编辑",
  ...
  "tui.voice.error.protocol": "语音控制回复不是有效的 voice_input 调用",
  "tui.voice.error.stale": "输入内容已变化，语音编辑已跳过",
