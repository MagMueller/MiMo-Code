...
export const dict = {
  ...
  "tui.skill.browser-use.description": "Browser Use CLI による既定のブラウザ操作",
  "tui.skill.playwright.description": "明示的な依頼に応じた Playwright CLI 自動化",
  ...
  "tui.voice.control.enabled": "スマート編集をオン — 編集の意図を理解します。考える時間が必要です",
  "tui.voice.control.disabled": "クイック入力に切替 — 意図理解なし。応答が速く、方言や騒音下でも精度が高めです",
  "tui.command.voice.control.title": "スマート編集 / クイック入力を切替",
  "tui.command.voice.control.title_on": "スマート編集：オン — クリックでクイック入力",
  "tui.command.voice.control.title_off": "クイック入力：オン — クリックでスマート編集",
