...
export const dict = {
  ...
  "tui.skill.browser-use.description": "預設透過 Browser Use CLI 操作瀏覽器",
  "tui.skill.playwright.description": "僅在明確要求時使用 Playwright CLI 自動化",
  ...
  "tui.skill.browser-use.slash": "瀏覽器自動化",
  ...
  "tui.command.voice.send.title": "切換語音發送",
  ...
  "tui.voice.send.enabled": "語音發送已啟用 — 語音控制模式下說「发送」即可提交輸入",
  "tui.voice.send.disabled": "語音發送已關閉",
  "tui.voice.control.enabled": "智能編輯已開啟 — 理解編輯意圖，需要一定思考時間",
  "tui.voice.control.disabled": "已切到快速輸入 — 無意圖理解，響應更快，方言/噪聲環境更穩",
  "tui.command.voice.control.title": "切換智能編輯 / 快速輸入",
  "tui.command.voice.control.title_on": "智能編輯：已開啟 — 點擊切到快速輸入",
  "tui.command.voice.control.title_off": "快速輸入：已開啟 — 點擊切到智能編輯",
